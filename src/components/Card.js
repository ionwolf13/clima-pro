...
export const Card = ({nextDay,currentLocation,counter}) => {
    ...
    return(
        <div className='card-comp' id='mini-card'>
            ...
            <div className='mini-card-detail'> 
                <p className='mini-card-detail' > <img src={statHighTemp} alt='icon' height='25'/> {currentLocation.forecastDays[counter].max_temp}<img src={currentLocation.currentDegree} alt='icon' height='12'/></p>
            </div>
            <div className='mini-card-detail'>
                <p className='mini-card-detail' > <img src={statLowTemp} alt='icon' height='25'/> {currentLocation.forecastDays[counter].min_temp}<img src={currentLocation.currentDegree} alt='icon' height='12'/></p>
            </div>
             */}
